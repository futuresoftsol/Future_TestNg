...
public class LoginPage {
	...
	public static void clickHeader() throws InterruptedException{
		...
		List<WebElement> paginationList = driver.findElements(By.xpath("//ul[@id='myPager']/li/a"));
		int count=0;
		for(int i=1; i<paginationList.size()-1;i++){
